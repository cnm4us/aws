...
| `message_impression` | in-feed message shown | `event_at`, `session_id`, `message_id`, `surface` | `message_campaign_key`, `message_campaign_category`, `delivery_context`, `journey_*`, `space_*`, device fields | Message funnel | For `slide_type=message` |
| `message_dismiss` | user scrolls past in-feed message | `event_at`, `session_id`, `message_id`, `surface` | `message_campaign_key`, `message_campaign_category`, `delivery_context`, `journey_*`, device fields | Message dismissal proxy | Includes pass-through / dismiss semantics |
| `message_click` | in-feed message CTA clicked | `event_at`, `session_id`, `message_id`, `surface` | `cta_kind`, `message_cta_slot`, `message_cta_definition_id`, `message_cta_intent_key`, `message_cta_executor_type`, `message_campaign_key`, `message_campaign_category`, `delivery_context`, `journey_*`, device fields | Message conversion | Canonical click event; slot/intent identify specific CTA |
