...
type ScreenTitleEditorState = {
  id: string
  start: number
  end: number
}

type ScreenTitleEditorModalProps = {
  screenTitleEditor: ScreenTitleEditorState
  screenTitleEditorError: string | null
  setScreenTitleEditor: React.Dispatch<React.SetStateAction<ScreenTitleEditorState | null>>
  setScreenTitleEditorError: React.Dispatch<React.SetStateAction<string | null>>
  totalSeconds: number
  onClose: () => void
  onSave: () => void
}

export default function ScreenTitleEditorModal({
  screenTitleEditor,
