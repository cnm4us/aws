...
type StillEditorState = { id: string; start: number; end: number }

type StillEditorModalProps = {
  stillEditor: StillEditorState
  stillEditorError: string | null
  setStillEditor: React.Dispatch<React.SetStateAction<StillEditorState | null>>
  setStillEditorError: React.Dispatch<React.SetStateAction<string | null>>
  onClose: () => void
  onSave: () => void
}

export default function StillEditorModal({
  stillEditor,
  stillEditorError,
  setStillEditor,
  setStillEditorError,
